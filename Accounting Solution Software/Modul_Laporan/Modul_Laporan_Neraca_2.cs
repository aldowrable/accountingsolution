...
{
    public partial class Modul_Laporan_Neraca : Form
    {
        private DbObject dbo = new DbObject();
        private Accounting_Solution_Software.Modul_Laporan.Akuntansi.Laporan_Neraca laporan_neraca = new Accounting_Solution_Software.Modul_Laporan.Akuntansi.Laporan_Neraca();

        public Modul_Laporan_Neraca()
        {
            InitializeComponent();
        }

        private void Modul_Laporan_Neraca_Load(object sender, EventArgs e)
        {
            set_tahun_cmb();
        }
        ...
        {
            setReport(new String[] { "@tgl" }, new String[] { tahunCMB.SelectedValue.ToString() }, laporan_neraca);
        }
